...
`docs/ono_sendai_shell_spec_v0.3_external_command_adapters.md` arrived mid-run. It specifies an
...
8. `ADAPT-009` the manifest schema and `docs/spec/adapters/` (§1.44, §1.66).
