...
`docs/spec/commands/process.yaml` advertised `ono.process-detail/1` for it, `deferred.yaml`
...
`docs/spec/schemas/process-detail.v1.yaml`: every `ono.process/1` field, same identity
