...
records: fifty-one of the fifty-three case references in `docs/decisions/` are real, and a rule
...
- **Exempt `docs/decisions/` from the check.** Rejected under AGENTS.md §14. Fifty-one of the
