...
- Status: accepted
- Date: 2026-08-29
- Spec refs: §31.22, §31.64, §31.65, §31.66, §31.68, `docs/spec/kuang/contributions.v1.yaml`
...
(`ono_kuang_protocol::CommandDocument`), and `docs/spec/kuang/contributions.v1.yaml` now records
...
`docs/spec/commands/*.yaml`'s (`stability`, `phase`, `privilege` and `provider_capability` are
...
- **`provider_capability` stays `None`** and the KUANG/11 capabilities go in
  ...
  `docs/spec/capabilities.yaml`, the other what the broker will check at invocation.
