...
and §4.7.4 said the spatial conformance suite is "generated from `docs/spec/providers/*.yaml` the
...
described accurately was a *drift check*: the provider claims live in `docs/spec/providers/*.yaml`
...
says the four §42 claims are *declared in* `docs/spec/providers/*.yaml` and held against the tree
