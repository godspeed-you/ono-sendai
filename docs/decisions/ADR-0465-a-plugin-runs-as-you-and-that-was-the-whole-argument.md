...
`docs/decisions/ADR-0422-the-rpm-database-is-one-provider-with-three-front-ends.md` decides that
...
`docs/decisions/` entirely. That exclusion is what this ADR is really about. It meant a false
