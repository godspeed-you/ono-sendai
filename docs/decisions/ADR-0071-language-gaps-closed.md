...
- Status: accepted
- Date: 2026-08-27
- Spec refs: §6.3, §6.4, §10.2, §18.1, §18.4, §19.4, §53, §54; `docs/spec/language.yaml`
  (`builtin_functions`, `current_value`), `docs/spec/commands/data.yaml` (`ono.data.each`,
...
`035-scripting-language`. `docs/spec/grammar.ebnf` and `docs/spec/language.yaml` gain the
