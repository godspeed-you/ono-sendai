...
Spec §18.4 says "`get job` returns structured job objects", and `docs/spec/commands/process.yaml`
...
`docs/spec/providers/linux-procfs.yaml`, and checked by the conformance test with the rest. It
