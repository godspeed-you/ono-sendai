...
The contracts changed first (AGENTS.md §7 step 1): `docs/spec/schemas/plugin.v1.yaml` and
`docs/spec/schemas/plugin-runtime.v1.yaml` gained the fields, the runtime record's default view
