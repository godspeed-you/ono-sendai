...
`docs/spec/commands/data.yaml` reserved `ono.data.tail`, `ono.data.join` and `ono.data.diff`
...
in `docs/spec/commands/data.yaml`. They stay `experimental` — spec §53's reservation is about
