...
ADR-0455 had already settled where a contract about streams lives: `docs/spec/hardening/
...
`docs/spec/hardening/streaming_classification.yaml`. Both answer the same question — what may a
...
**A second registry, `docs/spec/hardening/stream_ordering.yaml`.** Tidier by one axis and worse by
