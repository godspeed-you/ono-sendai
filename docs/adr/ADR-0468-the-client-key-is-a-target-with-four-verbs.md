...
session state under ADR-0090, both live in `docs/contracts/commands/remote.yaml`, and both get help,
...
the new schema contract. That is the cost of `docs/contracts/` being the public contract (spec §27), and
