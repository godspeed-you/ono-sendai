...
- The spelling is `neighbours`, which is what `docs/contracts/commands/spatial.yaml` and
  `docs/contracts/spatial/spaces.yaml` already write in their prose. The identifiers stay
