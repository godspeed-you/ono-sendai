...
### 1. One registry, `docs/contracts/hardening/limits.yaml`
...
declared key, a documented example in `docs/contracts/commands/meta.yaml` and an acceptance case, and
...
rather than declare constants, and `docs/contracts/hardening/remote_limits.yaml` — if §52.1's separate
