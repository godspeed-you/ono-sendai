...
2. **Two new derivations**, written down in `docs/contracts/adapters/schema.yaml`:
...
- Tests: the conformance harness over `docs/contracts/adapters/fixtures/procps/ps/`,
