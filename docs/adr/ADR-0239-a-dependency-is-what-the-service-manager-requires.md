...
- Spec refs: v0.4 §13 (a service place's groups include dependencies and dependents), §42.3 (an
  ...
  v0.2 §22.2–§22.4, §28.3, §35.3; `docs/contracts/spatial/relations.yaml` (`service.depends_on`);
  ADR-0135
- Decided by: agent (autonomous)

## Context

`docs/contracts/spatial/relations.yaml` declares `service.depends_on` with the groups `dependencies`
