...
`docs/contracts/commands/*.yaml` is where an option becomes real: help prints it, completion offers it,
...
`docs/contracts/commands/` and requires each of its option names to appear as a string literal —
