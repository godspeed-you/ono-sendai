...
`where level >= error`; §8.1 lists `log` as a target. `docs/contracts/commands/service.yaml`
...
1. **`ono.log-record/1` is written** (`docs/contracts/schemas/log-record.v1.yaml`): every field of
