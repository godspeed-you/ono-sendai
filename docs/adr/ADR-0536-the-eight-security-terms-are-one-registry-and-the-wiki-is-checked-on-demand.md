...
**One registry.** `docs/contracts/hardening/terminology.yaml` holds §19.1's eight terms, each with the
...
`docs/contracts/hardening/` and it obeys §52.2 the same way the others do: `docs/reference/terminology.md`
