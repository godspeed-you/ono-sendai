...
**`docs/contracts/hardening/remote_trust.yaml` holds the six.** Each concept carries what it
...
- `boundary` is recorded and not yet validated for membership.
  `docs/contracts/hardening/security_boundaries.yaml` — §6.1's inventory — is owed by issue #118 and
