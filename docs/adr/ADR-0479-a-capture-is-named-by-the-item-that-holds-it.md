...
is data in `docs/contracts/hardening/streaming_classification.yaml`, compared by `spec-check` against
...
**The inventory lives in `docs/contracts/hardening/streaming.yaml`, and a capture is identified by the
