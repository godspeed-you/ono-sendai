...
#[test]
#[ignore = "REASON: v0.4 spatial systems interface (docs/ono_sendai_shell_spec_v0.4_spatial_systems_interface.md §42.1); un-ignored by the increment that delivers it"]
...
#[test]
#[ignore = "REASON: v0.4 spatial systems interface (docs/ono_sendai_shell_spec_v0.4_spatial_systems_interface.md §34.2); un-ignored by the increment that delivers it"]
